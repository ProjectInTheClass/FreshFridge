            ...
            VStack{
                List{
                    ...
                    DisclosureGroup("2단계. 확인 학습", isExpanded: $revealDetails2){
                        Text("선사시대의 출발 지점인 구석기 시대와 관련된 문제를 풀어 봅시다.")
                        Image("2")
                            .resizable()
                            .aspectRatio(contentMode: .fit
                            )
                           ...
                           // Alert(title: Text("alert"), dismissButton: .cancel())
                            ...
                            let secondaryButton =
                                Alert.Button.default(Text("예")){
                                    revealDetails3.toggle()
                                    myInfo.ckOn5 = false
                                    myInfo.detailprogress5 = 0.2
                                    myInfo.totalvalue5 = 0.4
...
struct MDetailView5_Previews: PreviewProvider {
